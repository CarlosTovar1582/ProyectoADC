    ...
    return (
      <footer className="bg-gradient-to-t from-orange-400 via-orange-400 to-orange-300 rounded-3xl">
          ...
          */}
          ...
          <div className="grid grid-cols-4   w-full h-full   px-1 py-5  rounded-3xl xl:hidden font-cabecera text-1xl  ">
            <div className='col-span-4 mx-auto  text-white font-extrabold text-center font-cabecera '>NUESTROS SOCIOS</div>
            ...
            <div className='col-span-2 text-white  font-black flex justify-center font-cabecera'>UBICACIÒN</div>
            ...
            <div className='col-span-2 text-black font-bold text-center text-sm'>adcelectricperu@gmail.com</div>
            ...
            <div className="grid  grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-0   overflow-hidden px-1 py-10 rounded-3xl ">
              <div className='hidden xl:block col-span-6  text-white font-extrabold text-center '>
                <div className="grid grid-cols-6  ">
                  <div className='hidden xl:block col-span-6  text-white font-cabecera text-2xl text-center  rounded-xl'>NUESTROS SOCIOS</div>              
                  <br />
                  <div className=' col-span-6 flex justify-center items-center '>
                    <Marquee direction='left'>
                      <img src="https://i.postimg.cc/NM66qwwP/Whats-App-Image-2024-04-26-at-10-38-49-AM.jpg" className="h-40 w-40 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
                      <img src="https://i.postimg.cc/7PCM6x6T/snider1.png" className="h-40 w-96 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
                      <img src="https://i.postimg.cc/gjM6mzt4/Whats-App-Image-2024-04-26-at-10-41-10-AM.jpg" className="h-40 w-96 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
                      <img src="https://i.postimg.cc/8cmq0Hkw/chint.jpg" className="h-40 w-72 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
                      <img src="https://i.postimg.cc/XJ2WYcVN/Color-Siemens-Logo.webp" className="h-40 w-96 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
                      <img src="https://i.postimg.cc/fbpF38xc/autonic.jpg" className="h-40 w-96 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />                              
                    </Marquee>
                  ...
                  <div className='col-span-6 flex justify-center items-center '>
                    <Marquee direction='right'>
                      <img src="https://i.postimg.cc/VsXVLNtG/Whats-App-Image-2024-04-26-at-10-44-17-AM.jpg" className="h-40 w-auto rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
                      <img src="https://i.postimg.cc/jjrGhJy7/Whats-App-Image-2024-04-26-at-10-38-01-AM.jpg" className="h-40 w-96 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
                      <img src="https://i.postimg.cc/PqV1j0Tz/Whats-App-Image-2024-04-26-at-10-37-30-AM.jpg" className="h-40 w-96 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
                      <img src="https://i.postimg.cc/W49pfvTj/Whats-App-Image-2024-04-26-at-10-36-54-AM.jpg" className="h-40 w-96 rounded-2xl  transition duration-300 ease-in-out " alt="Flowbite Logo" />
              ...
              <div className='hidden xl:block col-span-6  text-white font-extrabold text-center  pl-8  '>
                ...
                <div className="grid grid-cols-2  ">
                  <div className=' text-white  font-cabecera text-2xl  text-right  pr-14 '>UBICACIÒN</div>
                  <div className=' text-white  flex justify-left font-cabecera text-2xl'>E-MAIL</div>
                  <div className=' text-black font-cabecera text-right  text-1xl  pr-14'>
                      Av.argentina cdra 523 centro comercial <br />
                      ACOPROM Tienda A30,A27 H15, Lima, Peru 
                  </div>
                  <div className=' text-black font-cabecera text-1xl text-left'>adcelectricperu@gmail.com</div>
                  <div className=' text-white font-cabecera text-2xl text-right pr-14 py-2'>TELEFONO</div>
                  <div className=' text-white font-cabecera text-2xl flex justify-left py-2'>REDES SOCIALES</div>
                  <div className=' text-black font-cabecera text-1xl text-right pr-14 '>
                  +51 (955) 750 856
                  </div>
          ...
          <div className="grid grid-cols-1    px-1 py-1   bg-white ">
            <div className='flex justify-center text-1xl'>
              <p className='font-cabecera text-1xl'>© 2024 All rights reserved | ADC Electric e Import SAC Lima-Peru </p>                          
            </div>            
          </div> 
