  ...
  return (  
    <header className="">
        <div className="grid grid-cols-4 gap-0 text-white  ">
              ...
              https://i.postimg.cc/5yVSSwgC/Logofinal-ADC1-FIN.png
              https://i.postimg.cc/HnWDP7sr/Logofinal-ADC1-FIN2.png
              https://i.postimg.cc/X7J6fFzh/Logofinal-ADC1-FIN3.png
              
              
              
              */}
                <div className='col-span-3 sm:col-span-3 md:col-span-2 lg:col-span-2 xl:col-span-2 mt-4 pl-4 '>
                  <img src="https://i.postimg.cc/X7J6fFzh/Logofinal-ADC1-FIN3.png" className="lg:h-64 transition duration-300 ease-in-out " alt="Flowbite Logo" />
                </div>
              ...
              { /* Mostrar Menu Completo border-2 border-blue-600 */}      
                <div className="hidden font-cabecera text-1xl lg:col-span-1 xl:col-span-2 xl:justify-center pl-2 pr-2 pt-2 pb-2 rounded-3xl items-center   xl:flex  ">                 
                          ...
                          <div className="fixed inset-0 ">                         
                            <Dialog.Panel className=" w-full  font-title text-1xl max-w-7xl transform overflow-hiddenrounded-2xl bg-gradient-to-t from-orange-300 via-orange-400 to-orange-300 p-6 text-left align-middle shadow-xl transition-all">
                              <div className="grid grid-cols-4 gap-0 text-black border-2 border-black-500 rounded-2xl ">
                                    ...
                                    {({ open }) => (
                                      <>
                                        ...
                                        <a
                                          ...
                                          className="font-cabecera -mx-3 block rounded-lg px-3 py-2 text-2xl font-semibold leading-7 text-white hover:bg-gray-800"
                                        >
                                          Productos
                                          </a>
                                          {/*     <ChevronDownIcon
                                ...
                                {/* 5 fila  */} 
                                {/* Fila de Contactos  */}
                                <div className='col-span-4  flex justify-center  mt-6 bg-slate-100 font-bold rounded-2xl font-cabecera'>
                                  Ventas
                                </div>    
                                <div className='flex justify-end mt-4'><PhoneIcon className="h-6 w-6 font-extralight" aria-hidden="true" /></div>  
                                <div className='flex justify-center font-bold mt-4 font-cabecera'>Tienda A30</div>  
                                <div className='col-span-2  flex justify-center mt-4 font-cabecera'>+51 986 701 992</div>

                                <div className='flex justify-end'><PhoneIcon className="h-6 w-6 font-extralight" aria-hidden="true" /> </div> 
                                <div className='flex justify-center font-bold font-cabecera'>Tienda H </div>                                
                                <div className='col-span-2  flex justify-center font-cabecera'>+51 905 454 861</div>  

                                <div className='flex justify-end'><PhoneIcon className="h-6 w-6 font-extralight" aria-hidden="true" /></div>  
                                <div className='flex justify-center font-bold font-cabecera'>Tienda A27</div> 
                                <div className='col-span-2  flex justify-center font-cabecera'>+51 944 278 201</div>   
                                ...
                                <div className='col-span-2  flex justify-center mt-4 font-cabecera'>+51 994 343 178</div>                                 
