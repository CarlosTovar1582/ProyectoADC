      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1  lg:grid-cols-2  gap-2  rounded-3xl bg-white    ">
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48   rounded-3xl  text-black 
          ...
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg ">
            ...
            <p className="mt-6 text-xl leading-8 text-white font-cabecera  ">
            ...
            <dl className="mt-10 space-y-4 text-base leading-7 text-gray-300">
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  <span className="sr-only font-cabecera">Address</span>
                  <BuildingOffice2Icon className="h-7 w-6 text-white" aria-hidden="true" />
                </dt>
                <dd className='text-white font-cabecera text-xl'>
              ...
              <div className="flex gap-x-4">
                ...
                <dd>
                  <a className="text-white text-xl font-cabecera" href="tel:+1 (555) 234-5678">
                    +51 (955) 750 856
                  </a>
                </dd>
              </div>
              <div className="flex gap-x-4">
                <dt className="flex-none">
                  <span className="sr-only font-cabecera">Email</span>
                  <EnvelopeIcon className="h-7 w-6 text-white" aria-hidden="true" />
                </dt>
                <dd>
                  <a className="text-white text-xl font-cabecera" href="mailto:hello@example.com">
        ...
        <form ref={form} onSubmit={sendEmail} method="POST" className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48  rounded-3xl border-2 border-slate-700">
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 font-cabecera">
              <div>
